...
```csharp
public class JTObject : JTParent, System.Collections.Generic.IReadOnlyList`1[[jsontwin.JTObjectProperty, jsontwin, Version=1.0.1.0, Culture=neutral, PublicKeyToken=null]], System.Collections.Generic.IReadOnlyCollection`1[[jsontwin.JTObjectProperty, jsontwin, Version=1.0.1.0, Culture=neutral, PublicKeyToken=null]], System.Collections.Generic.IEnumerable`1[[jsontwin.JTObjectProperty, jsontwin, Version=1.0.1.0, Culture=neutral, PublicKeyToken=null]], System.Collections.IEnumerable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [JTElement](https://github.com/blackrookgames/jsontwin/tree/main/jsontwin/docs/1.0.1/jsontwin.jtelement.md) → [JTParent](https://github.com/blackrookgames/jsontwin/tree/main/jsontwin/docs/1.0.1/jsontwin.jtparent.md) → [JTObject](https://github.com/blackrookgames/jsontwin/tree/main/jsontwin/docs/1.0.1/jsontwin.jtobject.md)<br>
...
[JTObjectProperty](https://github.com/blackrookgames/jsontwin/tree/main/jsontwin/docs/1.0.1/jsontwin.jtobjectproperty.md)<br>

## Constructors

### **JTObject()**

Initializer for [JTObject](https://github.com/blackrookgames/jsontwin/tree/main/jsontwin/docs/1.0.1/jsontwin.jtobject.md)
...
`out` `element` [JTElement](https://github.com/blackrookgames/jsontwin/tree/main/jsontwin/docs/1.0.1/jsontwin.jtelement.md)<br>
Property element
